...
describe('BlockReward', function () {
	...
	describe('returning calcReward', function () {
		...
		it('when height == (offset) should return 800000000', function () {
			expect(blockReward.calcReward(1451520)).to.equal(800000000);
		});

		it('when height == (offset + 1) should return 800000000', function () {
			expect(blockReward.calcReward(1451521)).to.equal(800000000);
		});

		it('when height == (offset + 2) should return 800000000', function () {
			expect(blockReward.calcReward(1451522)).to.equal(800000000);
		});

		it('when height == (distance) should return 800000000', function () {
			expect(blockReward.calcReward(3000000)).to.equal(800000000);
		});

		it('when height == (distance + 1) should return 800000000', function () {
			expect(blockReward.calcReward(3000001)).to.equal(800000000);
		});

		it('when height == (distance + 2) should return 800000000', function () {
			expect(blockReward.calcReward(3000002)).to.equal(800000000);
		});

		it('when height == (milestoneOne - 1) should return 500000000', function () {
			expect(blockReward.calcReward(4451519)).to.equal(800000000);
		});
		...
		it('when height == (milestoneTwo) should return 200000000', function () {
			expect(blockReward.calcReward(7451520)).to.equal(200000000);
		});

		it('when height == (milestoneTwo + 1) should return 200000000', function () {
		...
		it('when height == (milestoneThree) should return 200000000', function () {
			expect(blockReward.calcReward(10451520)).to.equal(100000000);
		});

		it('when height == (milestoneThree + 1) should return 200000000', function () {
			expect(blockReward.calcReward(10451521)).to.equal(100000000);
		});

		it('when height == (milestoneFour - 1) should return 200000000', function () {
			expect(blockReward.calcReward(13451519)).to.equal(100000000);
		});
	...
	describe('returning calcSupply', function () {
		...
		it('when height == 0 should return 6677610400000000', function () {
			expect(blockReward.calcSupply(0)).to.equal(6677610400000000);
		});

		it('when height == 1 should return 6677610400000000', function () {
			expect(blockReward.calcSupply(1)).to.equal(6677610400000000);
		});

		it('when height == (offset - 1) should return 6677610400000000', function () {
			expect(blockReward.calcSupply(1451519)).to.equal(6677610400000000);
		});
